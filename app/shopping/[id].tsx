  ...
  return (
    <View style={[styles.container, { paddingTop: topInset }]}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 100 }}>
        <View style={[styles.banner, { backgroundColor: store.color }]}>
          <Ionicons name={store.icon as any} size={56} color="rgba(255,255,255,0.9)" />
...
const styles = StyleSheet.create({
  ...
  banner: { height: 180, alignItems: 'center', justifyContent: 'center', position: 'relative' },
