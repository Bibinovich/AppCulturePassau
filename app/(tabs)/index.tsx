...
const styles = StyleSheet.create({
  ...
  greeting: { fontSize: 14, fontFamily: 'Poppins_400Regular', color: '#FFFFFF' },
  heroTitle: { fontSize: 26, fontFamily: 'Poppins_700Bold', color: '#FFFFFF' },
  ...
  quickPillIcon: { width: 40, height: 40, borderRadius: 14, alignItems: 'center', justifyContent: 'center' },
  ...
  sectionDot: { width: 20, height: 3, borderRadius: 2, backgroundColor: Colors.primary },
  ...
  featuredCard: { width: CARD_WIDTH, height: 260, borderRadius: 22, overflow: 'hidden' },
  featuredCardImage: { position: 'absolute', width: '100%', height: '100%' },
  featuredOverlay: {
    flex: 1,
    backgroundColor: 'rgba(0,0,0,0.2)',
    backgroundLinearGradient: 'linear-gradient(180deg, rgba(0,0,0,0.1) 0%, rgba(0,0,0,0.4) 100%)',
    padding: 18,
    justifyContent: 'space-between',
  },
  featuredTop: {
  ...
  restIcon: { width: 46, height: 46, borderRadius: 16, borderWidth: 0.5, borderColor: Colors.border },
  ...
  exploreCta: {
    ...
    alignItems: 'center',
    gap: 14,
    backgroundColor: 'rgba(212, 85, 42, 0.25)',
    borderRadius: 20,
    paddingHorizontal: 20,
    paddingVertical: 18,
    marginHorizontal: 20,
